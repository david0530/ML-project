...
# Example usage:
input_csv = 'test_data.csv'  # Path to your input CSV file
labels_csv = 'test_labels.csv'     # Path where the labels CSV should be saved
features_csv = 'test_features.csv' # Path where the features CSV should be saved
